...
def transform_date():
    raw_data_s3_bucket = "s3://redfin-emr-project/raw-data/city_market_tracker.tsv000.gz"
    transform_data_s3_bucket = "s3://redfin-emr-project/transformed-data/redfin_data.parquet"
